...
public class IntakePositionCommand extends Command{
    ...
    public IntakePositionCommand(JointSubsystem jointSubsystem, ElevatorSubsystem elevatorSubsystem) {
    ...
    protected Command getCommand() {
        ...
        return new SequentialCommandGroup(
            jointSubsystem.intakePositionCommand(),
            elevatorSubsystem.intakePositionCommand()
